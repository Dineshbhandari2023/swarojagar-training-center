...
const iconsMap: Record<string, React.ReactNode> = {
  "ac-repair": <Wrench className="h-6 w-6 text-sky-600 dark:text-sky-400" />,
  computer: <Laptop className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />,
  tailoring: <Scissors className="h-6 w-6 text-pink-600 dark:text-pink-400" />,
  cook: <Utensils className="h-6 w-6 text-amber-600 dark:text-amber-400" />,
  wiring: <Zap className="h-6 w-6 text-yellow-600 dark:text-yellow-400" />,
};
...
const bgColorsMap: Record<string, string> = {
  ...
  cook: "bg-amber-50 dark:bg-amber-950/20 border-amber-100 dark:border-amber-900/30",
  wiring:
    "bg-yellow-50 dark:bg-yellow-950/30 border-yellow-100 dark:border-yellow-900/30",
};
