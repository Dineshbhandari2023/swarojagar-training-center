...
export default function Facilities() {
  ...
  const cards = [
    ...
    },
    {
      ...
      bg: "bg-amber-50 dark:bg-amber-950/15 border-amber-100 dark:border-amber-900/20",
    },
  ];
  ...
  return (
    <section
      id="facilities"
      className="py-20 bg-white dark:bg-slate-950 transition-colors duration-350"
    >
