...
export default function Navbar() {
  ...
  return (
    <nav className=" fixed top-0 z-50 w-full backdrop-blur-md bg-white/5 dark:bg-slate-900/85 border-b border-slate-200/50 dark:border-slate-800/50 transition-colors duration-300">
