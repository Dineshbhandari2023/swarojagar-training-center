...
export default function Navbar() {
  ...
  // Smart navigation helper - returns the correct href based on current page
  const getNavHref = (section: string) => {
    // If on homepage, use anchor link for smooth scroll
  ...
  return (
    <nav className="sticky fixed top-0 z-50 w-full backdrop-blur-md bg-white/85 dark:bg-slate-900/85 border-b border-slate-200/50 dark:border-slate-800/50 transition-colors duration-300">
